...
function menuMobile() {
  var toggle = $(".menu-icon"),
    ...
    menuMobile = $(".full-navigation"),
    siteNav = $(".site-nav"),
    isClicked = true;

  toggle.click(func);
  menuClose.click(func);
  ...
  $(window).scroll(function(event) {
    ...
    if (scroll > navHeight && menuToggle.hasClass("is-active")) {
      menuToggle.removeClass("is-active");
      menuMobile.removeClass("is-active");
      isClicked = true;
    }
...
function particleBackground() {
  ...
  $('#hero-bg').particleground({
    dotColor: '#5cbdaa',
    lineColor: '#5cbdaa'
  });

  //particlesJS.load('hero-bg', '/assets/js/particles.json');
  //particlesJS.load('navigation-about-bg', '/assets/js/particlenasa.json');
...
function education() {
  ...
  $(window).scroll(function(event) {
    ...
    if (scroll < (edu.offset().top - wHeight)) {
      eduRow.removeClass("is-shown");
    }
